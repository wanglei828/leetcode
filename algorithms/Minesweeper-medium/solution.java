...
class Solution {
    ...
    private void dfs(char[][] board, int r, int c) {
        ...
        if(board[r][c] == 'E') {
            ...
            if(r-1>=0 && c+1<board[0].length && board[r-1][c+1] == 'M') {
                m++;
            }
            if(c+1<board[0].length && board[r][c+1] == 'M') {
                m++;
            }
            if(r+1<board.length && c+1<board[0].length && board[r+1][c+1] == 'M') {
                m++;
            }
            if(r+1<board.length && board[r+1][c] == 'M') {
                m++;
            }
            if(r+1<board.length && c-1>=0 && board[r+1][c-1] == 'M') {
                m++;
            }
